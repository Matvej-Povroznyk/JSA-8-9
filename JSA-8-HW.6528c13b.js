...
addBookmarkBtn.addEventListener(`click`, ()=>{
    const url = (0, _bookmark.normalizeUrl)(bookmarkInput.value);
    if (!url) return;
    const bookmarks = (0, _bookmark.addBookmark)(url);
...
bookmarkList.addEventListener(`click`, (e)=>{
    if (e.target.classList.contains("deleteBookmark-btn")) {
        ...
        const bookmarks = (0, _bookmark.deleteBookmark)(id);
        (0, _render.renderBookmarks)(bookmarks);
    }
});
(0, _render.renderBookmarks)((0, _bookmark.getBookmarks)());
...
},{"./bookmark":"eszqf","./render":"dvMGd"}],"eszqf":[function(require,module,exports,__globalThis) {
...
},{"nanoid":"328Fw","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"328Fw":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["6DHTQ","6kb64"], "6kb64", "parcelRequirec7da", {})

//# sourceMappingURL=JSA-8-HW.6528c13b.js.map
